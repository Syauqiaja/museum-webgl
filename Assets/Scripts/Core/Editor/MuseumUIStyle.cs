...
{
    /// <summary>
    /// Shared style source for every editor UI generator in the project — palette, font paths, the nine-slice
    /// ladder and the Create/Style helpers. Assets/Docs/ui-style.md is the prose; this is the executable copy.
    ///
    /// Meant to be pulled in with <c>using static</c>, which is why the members read as bare verbs at
    /// the call site.
    /// </summary>
    public static class MuseumUIStyle
    {
        ...
        public const string MediumFont = "Assets/Fonts/Roboto-Medium SDF.asset";
        public const string RegularFont = "Assets/Fonts/Roboto-Regular SDF.asset";

        /// <summary>
        /// The undo-stack entry every generator's created objects group under. Deliberately
        /// game-agnostic: this file is shared by the Egrang and lobby generators alike.
        /// </summary>
        public const string UndoLabel = "Build UI";
        ...
        /// <summary>
        /// One line of a specification list: a caption-sized label on the left, the value on the
        /// right, sized for a vertical layout group. Returns the value label — the half a view binds
        /// at runtime, since the caption is fixed copy.
        ///
        /// Shared rather than copied: the Egrang stick cards and the Egrang results panel both list
        /// caption/value pairs, and two implementations would drift apart on the first restyle.
        /// </summary>
        public static TMP_Text AddSpecRow(Transform parent, string name, string caption,
                                          string valueFont = null, Color? valueColor = null,
                                          float captionWidth = 54f)
        {
            ...
            // One word, one line. A wrapped caption ("Penampan/g") reads as a rendering fault.
            ...
            StyleText(value, valueFont ?? SemiBoldFont, 13f, valueColor ?? Color.white);
            value.alignment = TextAlignmentOptions.MidlineRight;
            value.textWrappingMode = TextWrappingModes.NoWrap;
            return value;
        }

        /// <summary>A hairline between a heading and the specification rows under it.</summary>
